      ...
      <div className="container mx-auto px-6 lg:px-12 max-w-4xl">
        ...
        >
              ...
              <div className="text-center">
                <button
                  ...
                  className={`px-8 py-3 rounded-lg font-medium transition-colors ${
                    isSearching ? "bg-gray-400 cursor-not-allowed" : "btn-primary"
                  }`}
                >
          ...
          <div className="mt-8 bg-primary-accent/10 p-6 rounded-2xl">
            <h3 className="text-xl font-playfair text-primary-dark mb-4">Información Importante</h3>
            <div className="text-neutral space-y-2">
              <p>
                • <strong>Quejas:</strong> Respuesta máxima en 5 días hábiles
              </p>
              <p>
                • <strong>Reclamos:</strong> Respuesta máxima en 15 días hábiles
              </p>

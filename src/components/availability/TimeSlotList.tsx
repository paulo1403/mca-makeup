...
const DAYS_OF_WEEK = [
  { name: 'Domingo', short: 'Dom', bgColor: 'bg-slate-50', borderColor: 'border-slate-200' },
  { name: 'Lunes', short: 'Lun', bgColor: 'bg-blue-50', borderColor: 'border-blue-200' },
  { name: 'Martes', short: 'Mar', bgColor: 'bg-blue-50', borderColor: 'border-blue-200' },
  { name: 'Miércoles', short: 'Mié', bgColor: 'bg-blue-50', borderColor: 'border-blue-200' },
  { name: 'Jueves', short: 'Jue', bgColor: 'bg-blue-50', borderColor: 'border-blue-200' },
  { name: 'Viernes', short: 'Vie', bgColor: 'bg-blue-50', borderColor: 'border-blue-200' },
  { name: 'Sábado', short: 'Sáb', bgColor: 'bg-amber-50', borderColor: 'border-amber-200' },
];
    ...
    return (
      <div className='text-center py-12'>
        ...
        <p className='text-gray-600 mb-4'>
          Configura tus días y horas de trabajo para que los clientes puedan reservar citas
        </p>
      </div>
    );
  }
            ...
            <div className='p-3 sm:p-4'>
              {daySlots.length > 0 ? (
                ...
                <div className='text-center py-6'>
                  ...
                  <button
                    onClick={() => {/* TODO: Agregar horario para este día específico */}}

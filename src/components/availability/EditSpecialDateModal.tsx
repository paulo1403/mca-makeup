...
export default function EditSpecialDateModal({
  ...
  const handleFormSubmit = (data: EditSpecialDateForm) => {
    ...
    const formattedData = {
      ...
      customHours:
        data.isAvailable && data.startTime && data.endTime
  ...
  return (
    <Modal
      open={isOpen && !!specialDate}
      onClose={handleClose}
      size="sm"
      ariaLabelledBy="edit-specialdate-title"
    >
                  ...
                  <label className="flex items-start cursor-pointer p-3 rounded-lg border border-[color:var(--color-border)] hover:bg-[color:var(--color-surface-elevated)] transition-colors">
                    ...
                    <div>
                      ...
                      <Typography
                        ...
                        className="text-[color:var(--color-muted)] mt-1"
                      >
                        Día libre, vacaciones, feriado, etc.
                      </Typography>
                    </div>
                  </label>
                  <label className="flex items-start cursor-pointer p-3 rounded-lg border border-[color:var(--color-border)] hover:bg-[color:var(--color-surface-elevated)] transition-colors">
                    ...
                    <div>
                      ...
                      <Typography
                        ...
                        className="text-[color:var(--color-muted)] mt-1"
                      >
                        Horario diferente al habitual (ej: San Valentín)
                      </Typography>
                    </div>
                  </label>
                </div>

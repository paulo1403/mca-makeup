...
export default function TransportCostCalculator() {
    ...
    return (
        <div id="calculadora-transporte" className="transport-calculator rounded-2xl border border-[color:var(--color-border)] bg-[color:var(--color-surface)] shadow-sm p-4 sm:p-6">
            <motion.div

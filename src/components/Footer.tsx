      ...
      <div className="footer-container">
        <div className="footer-grid">
          ...
          <div className="footer-brand">
            ...
            <Typography as="p" variant="p" className="footer-description text-sm">
              Maquillaje profesional para novias, eventos y fotografía — sofisticación natural y
          ...
          <div className="footer-contact">
            ...
            <div className="space-y-3">
              ...
              <div className="footer-contact-item">
                ...
                <a href="mailto:marcelacordero.bookings@gmail.com" className="footer-contact-link">
              ...
              <div className="footer-contact-item">
                ...
                <a href="tel:+51953879106" className="footer-contact-link">
                  +51 953 879 106
                </a>
              </div>
            </div>
            ...
            {/* Legal Links */}
            <div className="mt-6">
              <Typography as="h5" variant="h4" className="footer-nav-title text-sm mb-3">
                Legal
              </Typography>
              <ul className="footer-nav-list">

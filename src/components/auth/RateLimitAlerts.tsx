...
import { RateLimitInfo, formatTime } from '@/lib/auth-utils';
      ...
      <div className='bg-red-900/50 border border-red-500 rounded-lg p-4'>
        <div className='flex items-center space-x-3'>
          ...
          <div className='flex-1'>
            <h3 className='text-red-400 font-semibold'>Cuenta temporalmente bloqueada</h3>
        ...
        <div className='flex items-center space-x-3'>
          ...
          <div className='flex-1'>
            <p className='text-yellow-300 text-sm'>
              Te quedan <strong>{rateLimitInfo.attemptsLeft}</strong> intento{rateLimitInfo.attemptsLeft !== 1 ? 's' : ''} antes del bloqueo
            </p>
          </div>
        </div>
      </div>

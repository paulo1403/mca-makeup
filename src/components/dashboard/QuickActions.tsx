import { Calendar, CalendarDays, Clock, type LucideIcon, Settings } from "lucide-react";
  ...
  return (
    ...
    >
      <div className="flex items-start space-x-3">
        <div
          className={`flex items-center justify-center ${iconBgColor} rounded-full w-10 h-10 flex-shrink-0 transition-transform duration-200 group-hover:scale-105`}
        >

...
export default function Step5_Review() {
  ...
  const { subtotal, transport, nightShift, total, duration } =
    useBookingSummary(
      selected,
      services,
      transportEnabled,
  ...
  return (
    <div className="w-full space-y-5">
      ...
      >
        ...
        >
          Revisa tu solicitud y sigue la guía de pago.
        </Typography>
      </motion.div>
      ...
      >
        <div className="grid grid-cols-2 gap-3 text-xs mb-3">
          ...
          <div className="text-[color:var(--color-heading)]">
            {watch("date") ? format(watch("date") as Date, "dd/MM/yyyy") : "—"}
          </div>
          <div className="flex items-center gap-2 text-[color:var(--color-muted)]">
        ...
        <div className="grid grid-cols-2 gap-3 text-xs mb-3">
          ...
          <div className="text-[color:var(--color-heading)] truncate">
            {watch("phone") || "—"}
          </div>
          <div className="flex items-center gap-2 text-[color:var(--color-muted)]">
              ...
              <label className="flex items-start gap-3 p-3 rounded-xl border border-[color:var(--color-border)] bg-[color:var(--color-surface)]">
                <div className="flex-shrink-0 mt-0.5">
                  <input
                    ...
                    className="w-5 h-5 border border-[color:var(--color-border)] rounded bg-[color:var(--color-surface)] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[color:var(--color-primary)]"
      ...
      >
        <div className="flex items-start gap-2">
          ...
          <div className="flex-1">
            ...
            >
              El depósito confirma tu reserva.
            </Typography>
          </div>
        </div>
      </motion.div>

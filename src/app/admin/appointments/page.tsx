      ...
      <div className="min-h-screen bg-gray-50 flex items-center justify-center px-4">
        <div className="max-w-md w-full">
          <div className="bg-white rounded-xl shadow-lg p-6 text-center">
            ...
            <h2 className="text-xl font-semibold text-gray-900 mb-2">Error al cargar las citas</h2>
            ...
            <div>
              ...
              <div className="flex items-center space-x-4 mt-1">
                <div className="text-sm text-gray-600">
                  Total: <span className="font-semibold text-[#D4AF37]">{pagination?.total || 0}</span> citas
                </div>
          ...
          {appointments.length === 0 ? (
            <div className="text-center py-12">
              ...
              <p className="text-gray-500 mb-6">
                {filter !== 'all' ? 'No se encontraron citas con el filtro seleccionado' : 'Aún no tienes citas programadas'}
              </p>
              <button 

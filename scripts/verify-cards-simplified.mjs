...
const checks = [
  ...
  },
  {
    ...
    check:
      !content.includes("rounded-lg p-3 border border-[color") ||
      !content.includes("Servicios: {formatPrice"),
  },
  {
  ...
  },
  {
    ...
    check:
      content.includes('<Eye className="w-3.5 h-3.5" />') &&
      content.includes('<Trash2 className="w-3.5 h-3.5" />'),
  },
  {

...
const checks = [
  ...
  },
  {
    ...
    check: content.includes('p-3 rounded-lg border border-[color:var(--color-border)]\">') && content.includes('text-base font-semibold'),
  },
  {
  ...
  },
  {
    ...
    check: content.includes('space-y-2 text-xs') && content.includes('<h3 className="text-xs font-semibold'),
  },
  {
